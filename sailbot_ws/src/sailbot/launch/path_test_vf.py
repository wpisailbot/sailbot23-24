...
def generate_launch_description():
    ...
    network_comms_node = LifecycleNode(
        ...
        namespace='',
        output='screen',
        parameters=[{'map_name': LaunchConfiguration('map_name'), 'managed_nodes': ["heading_select", "ballast_control", "wind_smoother", "airmar_reader", "path_follower", "heading_controller", "esp32_comms"]}]
    )
